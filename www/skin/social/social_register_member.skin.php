...
<!-- 230105 수정-->
<link rel="stylesheet" href="<?php echo G5_THEME_URL; ?>/common/css/register.css">
...
<div class="social_register">
    ...
    <form name="fregisterform" id="fregisterform" action="<?php echo $register_action_url; ?>" onsubmit="return fregisterform_submit(this);" method="POST" autocomplete="off">
        ...
        <p class="inform"><i class="fa fa-check-circle" aria-hidden="true"></i> 회원가입약관 및 개인정보 수집 및 이용의 내용에 동의하셔야 회원가입 하실 수 있습니다.</p>
        ...
        <section id="fregister_term">
            <h2>
                회원가입약관 <strong>(필수)</strong>
                <span class="view-content down">
                    내용 보기
                    <img src="<?php echo G5_THEME_URL; ?>/common/img/sort_down.png" alt="">
                </span>
                <span class="view-content up">
                    내용 보기
                    <img src="<?php echo G5_THEME_URL; ?>/common/img/sort_up.png" alt="">
                </span>
            </h2>
...
<!-- 230105 윤영석 수정-->
<script src="<?php echo G5_THEME_URL; ?>/common/js/register.js"></script>
