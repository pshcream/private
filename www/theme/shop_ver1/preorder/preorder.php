...
?>
<link rel="stylesheet" href="<?php echo G5_THEME_URL; ?>/common/css/preorder.css?ver=<?php echo G5_CSS_VER; ?>">

<main>
    <div class="main-tbox">
        <h1>빠른출고</h1>
        <p>출고걱정은 그만!! 알차다쇼핑에서 빠른출고로 해결!!</p>
    </div>
    <div class="main-best">
            ...
            <div class="in">
                ...
                <div class="main-banner-tbox">
                    <form method="POST" name="main_submit" id="main_submit" class="" autocomplete="off">
                        <input type="hidden" name="location" id="location" value="하단상담신청(빠른출고)">
                        <div class="main-banner-title">
                            <h1>원하는 차량이 없으신가요?</h1>
                            <p>상담 가능한 연락처를 남겨주시면 상담원이 직접 원하시는 차량 검색을 도와드립니다.</p>
                            <div class="main-radio-box">
                                <div class="form-wrap">
                                    <input type="radio" name="product" id="product1" class="chk-control" checked="" value="R">
                                    <label for="product1" class="chk-label">장기렌트</label>
                                </div>
                                <div class="form-wrap">
                                    <input type="radio" name="product" id="product2" class="chk-control" value="L">
...
<script src="<?php echo G5_THEME_URL; ?>/common/js/preorder.js?ver=<?php echo G5_JS_VER; ?>"></script>
