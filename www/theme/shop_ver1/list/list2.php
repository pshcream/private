...
?>
<link rel="stylesheet" href="<?php echo G5_THEME_URL; ?>/common/css/list2.css?ver=<?php echo G5_CSS_VER; ?>">
...
<script src="<?php echo G5_THEME_URL; ?>/common/js/list2.js?ver=<?php echo G5_JS_VER; ?>"></script>
