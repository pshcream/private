...
?>
<link rel="stylesheet" href="<?php echo G5_THEME_URL; ?>/common/css/list.css?ver=<?php echo G5_CSS_VER; ?>">

<!-- 국산차 인기상품 -->
<main class="main-import">
    <div class="main-tbox">
        <h1>빠른견적</h1>
        <p>영업사원 수수료 0%, 직접 내서 더 싸다!</p>
    </div>
...
<script src="<?php echo G5_THEME_URL; ?>/common/js/list.js?ver=<?php echo G5_JS_VER; ?>"></script>
