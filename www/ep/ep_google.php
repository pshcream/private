...
for ($i=0; $row=sql_fetch_array($result); $i++){
	$price = $row['R36M2']."KRW";//7월14일 변경예정
    ...
    for ($i=0; $i<$rcnt; $i++){
        ...
        echo "\n{$id}{$tab}{$title}{$tab}{$price}{$tab}{$link1}{$tab}{$image_link}{$tab}{$category_name1}{$tab}{$category_name2}{$tab}{$category_name3}{$tab}{$naver_category}{$tab}{$product_flag}{$tab}{$brand}{$tab}{$maker}{$tab}{$origin}{$tab}{$event_words}{$tab}{$point}{$tab}{$rental_info}{$tab}{$search_tag}{$tab}{$shipping}{$tab}{$attribute}{$tab}{$update_time}";
    }
    for ($i=0; $i<$rcnt; $i++){
        $j = $i + 6;
        if ($fuel_str==="하이브리드"){
            ...
            echo "\n{$id}{$tab}{$title}{$tab}{$price}{$tab}{$availablility}{$tab}{$link1}{$tab}{$image_link}{$tab}{$category_name1}{$tab}{$category_name2}{$tab}{$category_name3}{$tab}{$naver_category}{$tab}{$product_flag}{$tab}{$brand}{$tab}{$maker}{$tab}{$origin}{$tab}{$event_words}{$tab}{$point}{$tab}{$rental_info}{$tab}{$search_tag}{$tab}{$shipping}{$tab}{$attribute}{$tab}{$update_time}";
        }
    }
