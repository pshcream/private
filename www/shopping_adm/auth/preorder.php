...
<head>
	...
	<script src="/shopping_adm/js/rchada.js"></script>
									...
									<div class="row">
										<div class="col-sm-1">
											<div class="form-group">
												...
												<option value="특판|다이렉트">특판|다이렉트</option>-->
													<option value="대리점|다이렉트">대리점|다이렉트</option>
												</select>
											</div>
										</div>
										<div class="col-sm-1">
											<div class="form-group">
												<?php echo getMatchData("matchForEst", "matchForEst", "차량매칭"); ?>
											</div>
										</div>
										<div class="col-sm-1">
											<div class="form-group">
											...
											?>
												...
												<tr>
													<td class="" colspan="<?php echo $colspan ?>">
														<?php echo ($res['matchForEst'] != "") ? "[Matched : " . $res['matchForEst'] . "]" : ""; ?>
				...
				success: function(msg) {
					...
					if (_model == 4013) {
						msg = {
							...
							"data": [{
								"idx": 48720,
								"name": "2021년형 전기 (롱레인지)(개별소비세 3.5% 적용)"
							}, {
								"idx": 48721,
								"name": "2021년형 전기 (스탠다드)(개별소비세 3.5% 적용)"
							}, {
								"idx": 49862,
								"name": "2023년형 전기 (롱레인지)(개별소비세 3.5% 적용)"
							}, {
								"idx": 49895,
								"name": "2023년형 전기 (스탠다드)(개별소비세 3.5% 적용)"
							}, {
								"idx": 49897,
								"name": "2023년형 전기 (영업용)(개별소비세 3.5% 적용)"
							}]
						};
					}
			...
			jQuery.ajax({
				...
				success: function(msg) {
					const data48720 = {
						...
						"data": [{
							"idx": 74350,
							"pretaxprice": 53037000,
							"price": 49800000,
							"name": "익스클루시브"
						}, {
							"idx": 74356,
							"pretaxprice": 56037000,
							"price": 52630000,
							"name": "익스클루시브 AWD"
						}, {
							"idx": 74351,
							"pretaxprice": 58095750,
							"price": 54550000,
							"name": "프레스티지"
						}, {
							"idx": 74357,
							"pretaxprice": 61095750,
							"price": 57370000,
							"name": "프레스티지 AWD"
						}]
					};
					const data48721 = {
						...
						"data": [{
							"idx": 74352,
							"pretaxprice": 50001750,
							"price": 46950000,
							"name": "익스클루시브"
						}, {
							"idx": 74360,
							"pretaxprice": 53001750,
							"price": 49780000,
							"name": "익스클루시브 AWD"
						}, {
							"idx": 74353,
							"pretaxprice": 54634500,
							"price": 51300000,
							"name": "프레스티지"
						}, {
							"idx": 74361,
							"pretaxprice": 57634500,
							"price": 54120000,
							"name": "프레스티지 AWD"
						}]
					};
			...
			jQuery.ajax({
				...
				const data74350 = {
					"info": {
						...
						"brandName": "현대",
						"modelName": "아이오닉 5",
						"lineupName": "2021년형 전기 (롱레인지)(개별소비세 3.5% 적용)",
						"classifyName": "중형SUV",
						"tmName": "자동",
						"fuelName": "전기"
					},
					"options": [{
						...
						"status": 1,
						"idx": "B12",
						"name": "[HGA] LED 테일게이트 램프",
						"description": ""
					}],
					"colors": [{
						"idx": "008",
						"name": "슈팅스타 그레이 매트(T5R)",
						"price": 200000,
						"rgbCode": "#3a3c3d",
						"status": 1
					}, {
						...
						"idx": "012",
						"name": "사이버 그레이 메탈릭(C5G)",
						"price": 0,
						"rgbCode": "#878787",
						"status": 1
					}, {
						"idx": "013",
						"name": "갤럭틱 그레이 메탈릭(R3G)",
						"price": 0,
						"rgbCode": "#4b4b4b",
						"status": 1
					}, {
				...
				const data74351 = {
					...
					"options": [{
						...
						"idx": "A23",
						"name": "디지털 사이드 미러",
						"description": "디지털 사이드 미러(카메라 및 OLED 모니터)"
					}, {
						"pretaxprice": 450000,
						"price": 440000,
						"restriction": "D",
				...
				const data74352 = {
					"info": {
						...
						"brandName": "현대",
						"modelName": "아이오닉 5",
						"lineupName": "2021년형 전기 (스탠다드)(개별소비세 3.5% 적용)",
						"classifyName": "중형SUV",
						"tmName": "자동",
						"fuelName": "전기"
					},
				...
				//const filter_list = ["74350","74351","74356","74357","74352","74353","74360","74361"];
				const filter_list = [74350, 74351, 74356, 74357, 74352, 74353, 74360, 74361];
				let filterflag = false;
				for (var i = 0; i < filter_list.length; i++) {
					//console.log(_dtl_trim.indexOf(filter_list[i]));
					//if(_dtl_trim.indexOf(filter_list[i])>0){
					if (_dtl_trim == filter_list[i]) {
						filterflag = true;

						msg = eval("data" + _dtl_trim);
