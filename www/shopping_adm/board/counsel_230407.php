											...
											<tbody>
												...
												?>
													<tr>
														...
														<td class="text-center"><?php echo $res['ca_name']; ?></td>
														<td class="text-center"><?php echo $cartype; ?></td>
														<td class="text-center"><?php echo $estSheet; ?></td>
														<td class="text-center"><?php echo ($res['wr_8'] != "") ? "<b>" . $res['wr_8'] . "</b><br/><br/>" : ""; ?><?php echo get_text($res['wr_3']); ?></td>
														<td class="text-center"><?php echo get_text($res['wr_1']); ?></td>
														<td class="text-center"><?php echo hyphen_hp_number(get_text($res['wr_2'])); ?></td>
														<td class="no-padding">
															<textarea class="form-control custom-contents " style="min-width:200px; width: 100%; height: 120px; resize: none; background: #fff;" readonly="readonly"><?php echo get_text($estRes[2]); ?></textarea>
														</td>
