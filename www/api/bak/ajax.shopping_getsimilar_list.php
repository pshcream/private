...
$qry = sql_query("SELECT * FROM (SELECT a.BRN_C_NO, a.BRN_C_NM, a.MODL_C_NO, a.DTL_TRIM_C_NO, a.MODL_C_NM, a.NATION, a.CLASSIFYCODE, b.R48M2, b.L48M2 FROM shopping_car_db a LEFT JOIN shopping_epdata_idx b ON a.DTL_TRIM_C_NO = b.DTL_TRIM_C_NO WHERE (R48M2 NOT IN(0)) AND (L48M2 NOT IN(0)) $sql_where ORDER BY R48M2 ASC) AS danawa GROUP BY MODL_C_NO ORDER BY R48M2 DESC");
