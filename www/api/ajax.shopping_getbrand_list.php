...
$brandList = array();
$qry = sql_query("SELECT * FROM (SELECT a.BRN_C_NO, a.BRN_C_NM, a.NATION FROM {$g5['shopping_cardb_table']} a LEFT JOIN {$g5['shopping_epdata_table']} b ON a.DTL_TRIM_C_NO = b.DTL_TRIM_C_NO WHERE (R48M2 NOT IN(0)) AND (L48M2 NOT IN(0)) $sql_where ORDER BY R48M2 ASC) AS danawa GROUP BY BRN_C_NO");
