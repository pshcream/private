            ...
            <div class="wrapper wrapper-content animated fadeInRight ">
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                <h5><i class="fa fa-key"></i> 일시불 캐시백률 <small>일시불 캐시백률을 수정합니다.</small></h5>
                            </div>
                            <div class="ibox-content">
                                <form id="frm_cf3" name="frm_cf3" action="roc_proc.php" onsubmit="return fn_ok3();" method="post" enctype="multipart/form-data" autocomplete="off">
                                    ...
                                    <div class="form-group">
                                        <label>일반구매 > 일시불 *</label>
                                        <input type="text" class="form-control input-sm" id="cf_3" name="cf_3" value="<?php echo $config['cf_3']; ?>" tabindex="1" placeholder="일시불 캐시백률을 입력해주세요.(ex. 3% -> 0.03)" />
                                    </div>
