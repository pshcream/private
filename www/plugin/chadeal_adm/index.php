...
$total_res = sql_fetch("select count(*) as cnt from {$g5['chadeal_application_table']} ");
                        ...
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content">
                                <div class="feed-activity-list">
                                    ...
                                    $sql = "select * from {$g5['chadeal_application_table']} where 1 order by wr_id desc limit 0, 10";
                                    $qry = sql_query($sql);
                                    ...
                                    ?>
                                        <div class="feed-element">
                                            ...
                                            <div>
                                                ...
                                                <strong class="text-navy"><?php echo get_text($res['wr_name']); ?></strong>
                                                <div>
                                                    <i class="fa fa-mobile"></i> : <?php echo preg_replace('/([0-9]+)-([0-9]+)-([0-9]{4})/', '${1}-****-$3', hyphen_hp_number(get_text($res['wr_content']))); ?>
                                                </div>
                                                <small class="pull-right text-muted"><?php echo $res['wr_9']; ?></small>
                                            </div>
                                        </div>
                                    <?php
                                    }
